...
${WEB_CHAT_URL}     http://100.30.7.241:8080/ewcsite/    #http://10.30.1.210:81/EWC_newSDK_AACC185_hostname/  #http://100.30.4.83:8080/ewcsite1/   #http://localhost:8080/ewcsite/          #http://100.30.6.97/webui63/home.html
...
##############################     CUSTOMER 1     #################################
@{CUST1_INFO}    cust_name_1    ${CUST1_EMAIL}    WC_oanh1
...
##############################     CUSTOMER 2     #################################
@{CUST2_INFO}    cust_name_2    WS_CUSTOMER2@acc7dc.com     WC_oanh1
...
${AGENT1_SUP}               WS_WC_Agent5_Blended
...
${AGENT2_MAIL}              WS_WC1@acc7dc.com
${AGENT2_SUP}               WS_WC_Agent5_Blended
...
${AGENT3_VOICE_URI}         sip:${AGENT3_PHONE_NUMBER}@aoc.com
${AGENT3_SKILLSET_WC1}      WC_SKILLSET_FOR_WC1
${AGENT3_SKILLSET_WC2}      WC_SKILLSET_FOR_EWC2
${AGENT3_SKILLSET_EM}       EM_SKILLSET_FOR_WC
${AGENT3_MAIL}              WS_WC1@acc7dc.com
${AGENT3_SUP}               WS_WC_Agent5_Blended
...
${AGENT4_SKILLSET_VOICE}    SKILLSET_FOR_WC
${AGENT4_MAIL}              WS_WC1@acc7dc.com
${AGENT4_SUP}               WS_WC_Agent5_Blended

#############################     AGENT_5     ###############################
#${AGENT5_USERNAME}          ${DOMAIN}\\WS_WC_Agent5_Blended
#${AGENT5_PASSWORD}          1_Abc_123
#${AGENT5_FIRSTNAME}         WS_WC_Agent5_Blended
#${AGENT5_LASTNAME}          WS_WC_Agent5_Blended
#${AGENT5_FULLNAME}          WS_WC_Agent5_Blended
#${AGENT5_ID}                6500725
#${AGENT5_PHONE_NUMBER}      6500725
#${AGENT5_VOICE_URI}         sip:${AGENT5_PHONE_NUMBER}@auracc8.com
#${AGENT5_SKILLSET_WC1}      WC_SKILLSET_FOR_WC1
#${AGENT5_SKILLSET_WC2}      WC_SKILLSET_FOR_WC2
#${AGENT5_SKILLSET_EM}      EM_SKILLSET_FOR_EM
#${AGENT5_SKILLSET_VOICE}    SKILLSET_FOR_WC
#${AGENT5_MAIL}              WS_WC_Agent5_blended@automation.tma.com
#${AGENT5_SUP}               WS_WC_Agent5_Blended
