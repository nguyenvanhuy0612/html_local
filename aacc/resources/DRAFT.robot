...
${WEB_CHAT_URL}     http://10.30.1.210:81/EWC_newSDK_AACC185_hostname/      #http://100.30.7.241:8080/ewcsite/       #http://10.30.1.210:81/EWC_newSDK_AACC185_hostname/    #http://localhost:8080/ewcsite/
...
${CUST1_DOMAIN}             auracc8.com.vn      #aoc.com
#${CUST1_URI}              sip:${CUST1_PHONE}@${CUST1_DOMAIN}
${CUST1_URI}              sip:6500719@auracc8.com.vn    #tel:${CUST1_PHONE};phone-context=dialstring       #tel:${CUST1_PHONE};phone-context=dialstring
...
${SUP_SKILLSET_VOICE1}      SKILLSET_FOR_SANITY1
...
${AGENT1_SKILLSET_VOICE1}      SKILLSET_FOR_SANITY1
...
${AGENT2_SKILLSET_VOICE1}      SKILLSET_FOR_SANITY1
...
${AGENT3_SKILLSET_VOICE1}      SKILLSET_FOR_SANITY1
...
${AGENT4_SKILLSET_VOICE1}      SKILLSET_FOR_SANITY1
...
#
#${AGENT4_USERNAME}          acc7dc\\nvtruong2
#${AGENT4_PASSWORD}          1_Abc_123
#${AGENT4_FIRSTNAME}         nvtruong2
#${AGENT4_LASTNAME}          nvtruong2
#${AGENT4_FULLNAME}          nvtruong2
#${AGENT4_ID}                28101
#${AGENT4_PHONE_NUMBER}      28101
#${AGENT4_VOICE_URI}         sip:${AGENT4_PHONE_NUMBER}@aOC.com      #sip:${AGENT4_PHONE_NUMBER}@auracc8.com
#${AGENT4_SKILLSET_VOICE1}      SKILLSET_FOR_SANITY1
##${AGENT4_SKILLSET_VOICE2}      SKILLSET_FOR_Voice2
#${AGENT4_SKILLSET_EM}      EM_SKILLSET_FOR_SANITY1
