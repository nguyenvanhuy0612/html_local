...
##############################     CUSTOMER 1     #################################
@{CUST1_INFO}    cust_name_1    WS_EM_customer1@acc7dc.com    WC_oanh1
${CUST1_NAME}         cust_name_1
${CUST1_EMAIL}        WS_EM_customer1@acc7dc.com
...
##############################     CUSTOMER 2     #################################
@{CUST2_INFO}    cust_name_2    WS_EM_customer2@acc7dc.com    WC_oanh1
${CUST2_NAME}         cust_name_2
${CUST2_EMAIL}        WS_EM_customer2@acc7dc.com
...
##############################     CUSTOMER 3     #################################
@{CUST3_INFO}    cust_name_3    WS_EM_CUSTOMER3@acc7dc.com    WC_oanh1
${CUST3_NAME}         cust_name_3
${CUST3_EMAIL}        WS_EM_CUSTOMER3@acc7dc.com
...
##############################     CUSTOMER 5     #################################
@{CUST5_INFO}    cust_name_5    WS5@acc7dc.com.com    WC_oanh1
...
##############################     CUSTOMER 6     #################################
@{CUST6_INFO}    cust_name_6    oanhho_cust6@acc7dc.com    WC_oanh1
${CUST6_NAME}         cust_name_6
${CUST6_EMAIL}        oanhho_cust6@acc7dc.com
...
##############################     CUSTOMER 7     #################################
@{CUST7_INFO}    ${EMPTY}    oanhho_cust7@acc7dc.com    WC_oanh1
${CUST7_NAME}         ${EMPTY}
...
############################     AGENT_1     ###############################
${AGENT1_USERNAME}          ${DOMAIN}\\AACC_AUTO_VOICE1
${AGENT1_PASSWORD}          1_Abc_123
${AGENT1_FIRSTNAME}         AACC_AUTO_VOICE1
${AGENT1_LASTNAME}          AACC_AUTO_VOICE1
${AGENT1_FULLNAME}          AACC_AUTO_VOICE1
${AGENT1_ID}                6500711
...
############################     AGENT_2     ###############################
${AGENT2_USERNAME}          ${DOMAIN}\\AACC_AUTO_VOICE2
${AGENT2_PASSWORD}          1_Abc_123
${AGENT2_FIRSTNAME}         AACC_AUTO_VOICE2
${AGENT2_LASTNAME}          AACC_AUTO_VOICE2
${AGENT2_FULLNAME}          AACC_AUTO_VOICE2
${AGENT2_ID}                6500717     #6500712
${AGENT2_PHONE_NUMBER}      6500717     #6500712
...
############################     AGENT_3     ###############################
${AGENT3_USERNAME}          ${DOMAIN}\\AACC_AUTO_VOICE3_BL
${AGENT3_PASSWORD}          1_Abc_123
${AGENT3_FIRSTNAME}         AACC_AUTO_VOICE3_BL
${AGENT3_LASTNAME}          AACC_AUTO_VOICE3_BL
${AGENT3_FULLNAME}          AACC_AUTO_VOICE3_BL
${AGENT3_ID}                6500713
...
############################     AGENT_4     ###############################
${AGENT4_USERNAME}          ${DOMAIN}\\AACC_AUTO_VOICE4_BL
${AGENT4_PASSWORD}          1_Abc_123
${AGENT4_FIRSTNAME}         AACC_AUTO_VOICE4_BL
${AGENT4_LASTNAME}          AACC_AUTO_VOICE4_BL
${AGENT4_FULLNAME}          AACC_AUTO_VOICE4_BL
${AGENT4_ID}                6500716     #6500714
...
#############################     AGENT_5     ###############################
#${AGENT5_USERNAME}          ${DOMAIN}\\AACC_AUTO_VOICE5_BL
#${AGENT5_PASSWORD}          1_Abc_123
#${AGENT5_FIRSTNAME}         AACC_AUTO_VOICE5_BL
#${AGENT5_LASTNAME}          AACC_AUTO_VOICE5_BL
#${AGENT5_FULLNAME}          AACC_AUTO_VOICE5_BL
#${AGENT5_ID}                55555
...
############################     AGENT_4     ###############################
${AGENT5_USERNAME}          ${DOMAIN}\\AACC_AUTO_VOICE4_BL
${AGENT5_PASSWORD}          1_Abc_123
${AGENT5_FIRSTNAME}         AACC_AUTO_VOICE4_BL
${AGENT5_LASTNAME}          AACC_AUTO_VOICE4_BL
${AGENT5_FULLNAME}          AACC_AUTO_VOICE4_BL
${AGENT5_ID}                6500714
${AGENT5_PHONE_NUMBER}      6500714
${AGENT5_VOICE_URI}         sip:${AGENT4_PHONE_NUMBER}@aoc.com  #@auracc8.com
${AGENT5_SKILLSET_VOICE1}      SKILLSET_FOR_Voice1
${AGENT5_SKILLSET_VOICE2}      SKILLSET_FOR_Voice2
${AGENT5_SKILLSET_EM}      EM_SKILLSET_FOR_EM
${AGENT5_SKILLSET_WC}      WC_SKILLSET_FOR_VOICE
