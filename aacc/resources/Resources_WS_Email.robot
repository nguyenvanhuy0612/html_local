...
${WEB_CHAT_URL}     http://100.30.7.241:8080/ewcsite/    #http://10.30.1.210:81/EWC_newSDK_AACC185_hostname/      #http://localhost:8080/ewcsite/          #http://100.30.6.97/webui63/home.html
...
##############################     CUSTOMER 2     #################################
@{CUST2_INFO}    cust_name_2    WS_CUSTOMER2@acc7dc.com
${CUST2_NAME}         cust_name_2
${CUST2_EMAIL}        WS_CUSTOMER2@acc7dc.com
...
##############################     CUSTOMER 3     #################################
@{CUST3_INFO}    cust_name_3    WS_CUSTOMER3@acc7dc.com
${CUST3_NAME}         cust_name_3
${CUST3_EMAIL}        WS_CUSTOMER3@acc7dc.com
...
##############################     CUSTOMER 4     #################################
@{CUST4_INFO}    cust_name_4    WS_EM_customer4444@acc7dc.com    WC_oanh1
${CUST4_NAME}         cust_name_4
${CUST4_EMAIL}        WS_EM_customer4444@acc7dc.com
...
############################     AGENT_1     ###############################
${AGENT1_USERNAME}          ${DOMAIN}\\AACC_AUTO_EM1_MM
${AGENT1_PASSWORD}          1_Abc_123
${AGENT1_FIRSTNAME}         AACC_AUTO_EM1_MM
${AGENT1_LASTNAME}          AACC_AUTO_EM1_MM
${AGENT1_FULLNAME}          AACC_AUTO_EM1_MM
${AGENT1_ID}                6500731
${AGENT1_SKILLSET_WC1}      WC_SKILLSET_FOR_EM
${AGENT1_SKILLSET_EM1}      EM_SKILLSET_FOR_EM1
${AGENT1_SKILLSET_EM2}      EM_SKILLSET_FOR_EM2
${AGENT1_SKILLSET_EM3}      EM_SKILLSET_FOR_EM3
${AGENT1_SKILLSET_EM4}      EM_SKILLSET_FOR_EM4
${AGENT1_SKILLSET_EM5}      EM_SKILLSET_FOR_EM5
${AGENT1_MAIL}              WS_EM1@acc7dc.com      #WS_EM_Agent1_MM@automation.tma.com
${AGENT1_SUP}               WS_EM

############################     AGENT_2     ###############################
${AGENT2_USERNAME}          ${DOMAIN}\\AACC_AUTO_EM2_MM
${AGENT2_PASSWORD}          1_Abc_123
${AGENT2_FIRSTNAME}         AACC_AUTO_EM2_MM
${AGENT2_LASTNAME}          AACC_AUTO_EM2_MM
${AGENT2_FULLNAME}          AACC_AUTO_EM2_MM
${AGENT2_ID}                6500732
${AGENT2_SKILLSET_WC1}      WC_SKILLSET_FOR_EM
${AGENT2_SKILLSET_EM1}      EM_SKILLSET_FOR_EM1
${AGENT2_SKILLSET_EM2}      EM_SKILLSET_FOR_EM2
${AGENT2_SKILLSET_EM3}      EM_SKILLSET_FOR_EM3
${AGENT2_SKILLSET_EM4}      EM_SKILLSET_FOR_EM4
${AGENT2_SKILLSET_EM5}      EM_SKILLSET_FOR_EM5
${AGENT2_MAIL}              WS_EM2@acc7dc.com   #WS_EM_Agent2_MM@automation.tma.com
${AGENT2_SUP}               WS_EM

############################     AGENT_3     ###############################
${AGENT3_USERNAME}          ${DOMAIN}\\AACC_AUTO_EM3_BL
${AGENT3_PASSWORD}          1_Abc_123
${AGENT3_FIRSTNAME}         AACC_AUTO_EM3_BL
${AGENT3_LASTNAME}          AACC_AUTO_EM3_BL
${AGENT3_FULLNAME}          AACC_AUTO_EM3_BL
${AGENT3_ID}                6500733
${AGENT3_SKILLSET_WC1}      WC_SKILLSET_FOR_EM
${AGENT3_SKILLSET_EM1}      EM_SKILLSET_FOR_EM1
${AGENT3_SKILLSET_EM2}      EM_SKILLSET_FOR_EM2
${AGENT3_SKILLSET_EM3}      EM_SKILLSET_FOR_EM3
${AGENT3_SKILLSET_EM4}      EM_SKILLSET_FOR_EM4
${AGENT3_SKILLSET_EM5}      EM_SKILLSET_FOR_EM5
${AGENT3_MAIL}              WS_EM3@acc7dc.com   #WS_EM_Agent3_MM@automation.tma.com
${AGENT3_SUP}               WS_EM

############################     AGENT_4     ###############################
${AGENT4_USERNAME}          ${DOMAIN}\AACC_AUTO_EM4_BL
${AGENT4_PASSWORD}          1_Abc_123
${AGENT4_FIRSTNAME}         AACC_AUTO_EM4_BL
${AGENT4_LASTNAME}          AACC_AUTO_EM4_BL
${AGENT4_FULLNAME}          AACC_AUTO_EM4_BL
${AGENT4_ID}                6500734
${AGENT4_PHONE_NUMBER}      6500734
${AGENT4_VOICE_URI}         sip:${AGENT4_PHONE_NUMBER}@aoc.com
${AGENT4_SKILLSET_WC1}      WC_SKILLSET_FOR_EM
${AGENT4_SKILLSET_EM1}      EM_SKILLSET_FOR_EM1
${AGENT4_SKILLSET_EM2}      EM_SKILLSET_FOR_EM2
${AGENT4_SKILLSET_EM3}      EM_SKILLSET_FOR_EM3
${AGENT4_SKILLSET_EM4}      EM_SKILLSET_FOR_EM4
${AGENT4_SKILLSET_EM5}      EM_SKILLSET_FOR_EM5
${AGENT4_SKILLSET_VOICE}    SKILLSET_FOR_EM
${AGENT4_MAIL}              WS_EM4@acc7dc.com   #WS_EM_Agent4_blended@automation.tma.com
${AGENT4_SUP}               WS_EM
#
#############################     AGENT_5     ###############################
#${AGENT5_USERNAME}          ${DOMAIN}\\WS_EM_Agent5_Blended
#${AGENT5_PASSWORD}          1_Abc_123
#${AGENT5_FIRSTNAME}         WS_EM_Agent5_Blended
#${AGENT5_LASTNAME}          WS_EM_Agent5_Blended
#${AGENT5_FULLNAME}          WS_EM_Agent5_Blended
#${AGENT5_ID}                6500735
#${AGENT5_PHONE_NUMBER}      6500735
#${AGENT5_VOICE_URI}         sip:${AGENT5_PHONE_NUMBER}@auracc8.com
#${AGENT5_SKILLSET_WC1}      WC_SKILLSET_FOR_EM
#${AGENT5_SKILLSET_EM1}      EM_SKILLSET_FOR_EM1
#${AGENT5_SKILLSET_EM2}      EM_SKILLSET_FOR_EM2
#${AGENT5_SKILLSET_EM3}      EM_SKILLSET_FOR_EM3
#${AGENT5_SKILLSET_EM4}      EM_SKILLSET_FOR_EM4
#${AGENT5_SKILLSET_EM5}      EM_SKILLSET_FOR_EM5
#${AGENT5_SKILLSET_VOICE}    SKILLSET_FOR_EM
#${AGENT5_MAIL}              WS_EM5@acc7dc.com    #WS_EM_Agent5_blended@automation.tma.com
#${AGENT5_SUP}               WS_EM
