...
url_list_mega = 'https://vietlott.vn/en/trung-thuong/ket-qua-trung-thuong/so-ket-qua?gameid=3&nocatche=1'
url_details_mega = 'https://vietlott.vn/vi/trung-thuong/ket-qua-trung-thuong/645?id=00003&nocatche=1'

url_list_power = 'https://vietlott.vn/vi/trung-thuong/ket-qua-trung-thuong/so-ket-qua?gameid=4&nocatche=1'
# setup.driver_get_url(url=url_list_power)
